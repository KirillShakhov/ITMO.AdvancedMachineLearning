...
print('вероятность выжить если пассажир -- представитель следующей категории: female and pclass:1:', df[(df['sex'] == 'female') & (df['pclass'] == 1)]['survived'].sum() / len(df[(df['sex'] == 'female') & (df['pclass'] == 1)]))
